...
SECRET_KEY = 'django-insecure-@h3!k5$_w=67jqy+67!t49*a5taoe48i+b4)u%5d6h_f&vppgs'
...
WSGI_APPLICATION = 'aiengine.wsgi.application'
...
PERMIT_API_KEY = config('PERMIT_API_KEY', default='')
PERMIT_PDP_URL = config('PERMIT_PDP_URL', default='')
